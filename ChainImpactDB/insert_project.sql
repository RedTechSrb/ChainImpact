...
INSERT INTO public.project(
	...
	impactorid, 
	primarycausetypeid, secondarycausetypeid)
	VALUES ((select id from charity where name like 'UNICEF'), 'Cancer Treatment for Children - St. Jude Children''s Research Hospital ', 
		null,
...
INSERT INTO public.project(
	...
	impactorid, 
	primarycausetypeid, secondarycausetypeid)
	VALUES ((select id from charity where name like 'Novak Djokovic Foundation'), 'Innovative Sustainable Environment Education', 
		null,
