...
import { IconBrandDiscord, IconBrandInstagram, IconBrandTwitter } from "@tabler/icons";
    ...
    return (
      ...
      >
        <Grid>
          ...
          <Grid.Col span={12}>
            <SupportedProjects projects={projects} impactorName={impactor.name}></SupportedProjects>
          </Grid.Col>
